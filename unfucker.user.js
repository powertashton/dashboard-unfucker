...
Unfortunately a fixed header is a bit buggy so remove at your own risk!*/
  ...
  /*Sticky Header*/
  .ZkG01 .h_Erh { /* newDesktopLayout navigationWrapper */
    z-index: 99 !important;
    position: fixed !important;
    max-width: 990px;
  }
  .gM9qK > .N5wJr { /* navigationLinks > searchSidebarItem */
    padding-top: 12px;
  ...
  html
    body#tumblr.palette--trueBlue.xkit--react
    div#root
    div
    div#base-container
    div.D5eCV
    ...
    div.j8ha0
    div.zAlrA
    div.rZlUD.KYCZY.F4Tcn
    div.So6RQ.YSitt.norecommended-done.xpostblock-done
    div.ge_yK
    div.c79Av
    article.FtjPK.r0etU.hMVn9
    header.BjErQ.PpzOx
    div.q4Pce.J_Wh8
    div.ZJdm4
    div.ffqNn
  ...
  div.hyiL2
    ...
    > div
    > div.MCavR
    > div:nth-child(2):has(.TRX6J[aria-label="Share"]) {
    margin-left: 10px;
  }
...
you may need to change it with other colour pallets)*/
  ...
  .jL4Qq {
    ...
    border: 1px solid rgba(var(--white-on-dark), 0.13);
  }
